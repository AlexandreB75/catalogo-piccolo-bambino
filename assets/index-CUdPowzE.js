 ...
 *
 * @license MIT
 */function wo(){return wo=Object.assign?Object.assign.bind():function(t){for(var e=1;e<arguments.length;e++){var n=arguments[e];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(t[r]=n[r])}return t},wo.apply(this,arguments)}const hf=F.createContext(null),LR=F.createContext(null),Mo=F.createContext(null),du=F.createContext(null),Qr=F.createContext({outlet:null,matches:[],isDataRoute:!1}),TE=F.createContext(null);function Fo(){return F.useContext(du)!=null}function df(){return Fo()||Oe(!1),F.useContext(du).location}function IE(t){F.useContext(Mo).static||F.useLayoutEffect(t)}function es(){let{isDataRoute:t}=F.useContext(Qr);return t?QR():MR()}function MR(){Fo()||Oe(!1);let t=F.useContext(hf),{basename:e,future:n,navigator:r}=F.useContext(Mo),{matches:i}=F.useContext(Qr),{pathname:s}=df(),o=JSON.stringify(vE(i,n.v7_relativeSplatPath)),l=F.useRef(!1);return IE(()=>{l.current=!0}),F.useCallback(function(h,f){if(f===void 0&&(f={}),!l.current)return;if(typeof h=="number"){r.go(h);return}let p=EE(h,JSON.parse(o),s,f.relative==="path");t==null&&e!=="/"&&(p.pathname=p.pathname==="/"?e:Dr([e,p.pathname])),(f.replace?r.replace:r.push)(p,f.state,f)},[e,r,o,s,t])}function FR(t,e){return UR(t,e)}function UR(t,e,n,r){Fo()||Oe(!1);let{navigator:i}=F.useContext(Mo),{matches:s}=F.useContext(Qr),o=s[s.length-1],l=o?o.params:{};o&&o.pathname;let u=o?o.pathnameBase:"/";o&&o.route;let h=df(),f;if(e){var p;let k=typeof e=="string"?Gr(e):e;u==="/"||(p=k.pathname)!=null&&p.startsWith(u)||Oe(!1),f=k}else f=h;let m=f.pathname||"/",w=m;if(u!=="/"){let k=u.replace(/^\//,"").split("/");w="/"+m.replace(/^\//,"").split("/").slice(k.length).join("/")}let C=dR(t,{pathname:w}),P=WR(C&&C.map(k=>Object.assign({},k,{params:Object.assign({},l,k.params),pathname:Dr([u,i.encodeLocation?i.encodeLocation(k.pathname).pathname:k.pathname]),pathnameBase:k.pathnameBase==="/"?u:Dr([u,i.encodeLocation?i.encodeLocation(k.pathnameBase).pathname:k.pathnameBase])})),s,n,r);return e&&P?F.createElement(du.Provider,{value:{location:wo({pathname:"/",search:"",hash:"",state:null,key:"default"},f),navigationType:qn.Pop}},P):P}function jR(){let t=GR(),e=bR(t)?t.status+" "+t.statusText:t instanceof Error?t.message:JSON.stringify(t),n=t instanceof Error?t.stack:null,i={padding:"0.5rem",backgroundColor:"rgba(200,200,200, 0.5)"};return F.createElement(F.Fragment,null,F.createElement("h2",null,"Unexpected Application Error!"),F.createElement("h3",{style:{fontStyle:"italic"}},e),n?F.createElement("pre",{style:i},n):null,null)}const BR=F.createElement(jR,null);class zR extends F.Component{constructor(e){super(e),this.state={location:e.location,revalidation:e.revalidation,error:e.error}}static getDerivedStateFromError(e){return{error:e}}static getDerivedStateFromProps(e,n){return n.location!==e.location||n.revalidation!=="idle"&&e.revalidation==="idle"?{error:e.error,location:e.location,revalidation:e.revalidation}:{error:e.error!==void 0?e.error:n.error,location:n.location,revalidation:e.revalidation||n.revalidation}}componentDidCatch(e,n){console.error("React Router caught the following error during render",e,n)}render(){return this.state.error!==void 0?F.createElement(Qr.Provider,{value:this.props.routeContext},F.createElement(TE.Provider,{value:this.state.error,children:this.props.component})):this.props.children}}function $R(t){let{routeContext:e,match:n,children:r}=t,i=F.useContext(hf);return i&&i.static&&i.staticContext&&(n.route.errorElement||n.route.ErrorBoundary)&&(i.staticContext._deepestRenderedBoundaryId=n.route.id),F.createElement(Qr.Provider,{value:e},r)}function WR(t,e,n,r){var i;if(e===void 0&&(e=[]),n===void 0&&(n=null),r===void 0&&(r=null),t==null){var s;if(!n)return null;if(n.errors)t=n.matches;else if((s=r)!=null&&s.v7_partialHydration&&e.length===0&&!n.initialized&&n.matches.length>0)t=n.matches;else return null}let o=t,l=(i=n)==null?void 0:i.errors;if(l!=null){let f=o.findIndex(p=>p.route.id&&(l==null?void 0:l[p.route.id])!==void 0);f>=0||Oe(!1),o=o.slice(0,Math.min(o.length,f+1))}let u=!1,h=-1;if(n&&r&&r.v7_partialHydration)for(let f=0;f<o.length;f++){let p=o[f];if((p.route.HydrateFallback||p.route.hydrateFallbackElement)&&(h=f),p.route.id){let{loaderData:m,errors:w}=n,C=p.route.loader&&m[p.route.id]===void 0&&(!w||w[p.route.id]===void 0);if(p.route.lazy||C){u=!0,h>=0?o=o.slice(0,h+1):o=[o[0]];break}}}return o.reduceRight((f,p,m)=>{let w,C=!1,P=null,k=null;n&&(w=l&&p.route.id?l[p.route.id]:void 0,P=p.route.errorElement||BR,u&&(h<0&&m===0?(YR("route-fallback"),C=!0,k=null):h===m&&(C=!0,k=p.route.hydrateFallbackElement||null)));let E=e.concat(o.slice(0,m+1)),_=()=>{let S;return w?S=P:C?S=k:p.route.Component?S=F.createElement(p.route.Component,null):p.route.element?S=p.route.element:S=f,F.createElement($R,{match:p,routeContext:{outlet:f,matches:E,isDataRoute:n!=null},children:S})};return n&&(p.route.ErrorBoundary||p.route.errorElement||m===0)?F.createElement(zR,{location:n.location,revalidation:n.revalidation,component:P,error:w,children:_(),routeContext:{outlet:null,matches:E,isDataRoute:!0}}):_()},null)}var SE=function(t){return t.UseBlocker="useBlocker",t.UseRevalidator="useRevalidator",t.UseNavigateStable="useNavigate",t}(SE||{}),RE=function(t){return t.UseBlocker="useBlocker",t.UseLoaderData="useLoaderData",t.UseActionData="useActionData",t.UseRouteError="useRouteError",t.UseNavigation="useNavigation",t.UseRouteLoaderData="useRouteLoaderData",t.UseMatches="useMatches",t.UseRevalidator="useRevalidator",t.UseNavigateStable="useNavigate",t.UseRouteId="useRouteId",t}(RE||{});function HR(t){let e=F.useContext(hf);return e||Oe(!1),e}function qR(t){let e=F.useContext(LR);return e||Oe(!1),e}function KR(t){let e=F.useContext(Qr);return e||Oe(!1),e}function AE(t){let e=KR(),n=e.matches[e.matches.length-1];return n.route.id||Oe(!1),n.route.id}function GR(){var t;let e=F.useContext(TE),n=qR(),r=AE();return e!==void 0?e:(t=n.errors)==null?void 0:t[r]}function QR(){let{router:t}=HR(SE.UseNavigateStable),e=AE(RE.UseNavigateStable),n=F.useRef(!1);return IE(()=>{n.current=!0}),F.useCallback(function(i,s){s===void 0&&(s={}),n.current&&(typeof i=="number"?t.navigate(i):t.navigate(i,wo({fromRouteId:e},s)))},[t,e])}const Cg={};function YR(t,e,n){Cg[t]||(Cg[t]=!0)}function XR(t,e){t==null||t.v7_startTransition,t==null||t.v7_relativeSplatPath}function Ps(t){let{to:e,replace:n,state:r,relative:i}=t;Fo()||Oe(!1);let{future:s,static:o}=F.useContext(Mo),{matches:l}=F.useContext(Qr),{pathname:u}=df(),h=es(),f=EE(e,vE(l,s.v7_relativeSplatPath),u,i==="path"),p=JSON.stringify(f);return F.useEffect(()=>h(JSON.parse(p),{replace:n,state:r,relative:i}),[h,p,i,n,r]),null}function ai(t){Oe(!1)}function JR(t){let{basename:e="/",children:n=null,location:r,navigationType:i=qn.Pop,navigator:s,static:o=!1,future:l}=t;Fo()&&Oe(!1);let u=e.replace(/^\/*/,"/"),h=F.useMemo(()=>({basename:u,navigator:s,static:o,future:wo({v7_relativeSplatPath:!1},l)}),[u,l,s,o]);typeof r=="string"&&(r=Gr(r));let{pathname:f="/",search:p="",hash:m="",state:w=null,key:C="default"}=r,P=F.useMemo(()=>{let k=_E(f,u);return k==null?null:{location:{pathname:k,search:p,hash:m,state:w,key:C},navigationType:i}},[u,f,p,m,w,C,i]);return P==null?null:F.createElement(Mo.Provider,{value:h},F.createElement(du.Provider,{children:n,value:P}))}function ZR(t){let{children:e,location:n}=t;return FR(Bh(e),n)}new Promise(()=>{});function Bh(t,e){e===void 0&&(e=[]);let n=[];return F.Children.forEach(t,(r,i)=>{if(!F.isValidElement(r))return;let s=[...e,i];if(r.type===F.Fragment){n.push.apply(n,Bh(r.props.children,s));return}r.type!==ai&&Oe(!1),!r.props.index||!r.props.children||Oe(!1);let o={id:r.props.id||s.join("-"),caseSensitive:r.props.caseSensitive,element:r.props.element,Component:r.props.Component,index:r.props.index,path:r.props.path,loader:r.props.loader,action:r.props.action,errorElement:r.props.errorElement,ErrorBoundary:r.props.ErrorBoundary,hasErrorBoundary:r.props.ErrorBoundary!=null||r.props.errorElement!=null,shouldRevalidate:r.props.shouldRevalidate,handle:r.props.handle,lazy:r.props.lazy};r.props.children&&(o.children=Bh(r.props.children,s)),n.push(o)}),n}/**
