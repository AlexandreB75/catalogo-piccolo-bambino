...
import MonteSeuQuarto from './components/MonteSeuQuarto'
    ...
    <AuthContext.Provider value={{ user }}>
      <HashRouter>
        <Routes>
          ...
          <Route path="/quarto" element={<MonteSeuQuarto />} />
          ...
          <Route path="/admin-bio" element={ user ? <AdminBio />        : <Navigate to="/login" />} />
        </Routes>
      </HashRouter>
